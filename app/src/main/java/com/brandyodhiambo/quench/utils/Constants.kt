package com.brandyodhiambo.quench.utils

object Constants {
    const val WAKE_TIME_TABLE = "wake_time_table"
    const val SLEEP_TIME_TABLE = "sleep_time_table"
    const val IDEAL_WATER_TABLE = "ideal_water_table"
